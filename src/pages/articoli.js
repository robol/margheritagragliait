  ...
  return (
    <Layout>
      ...
      <div style={{ padding: "20px" }}>
        ...
        <ul className={style.listConferenze}>
          <li className={style.listItemConferenze}>
            <strong>Graglia M.</strong> (2020). &ldquo;Fare formazione sui temi
            LGBT nelle istituzioni pubbliche: il caso del{" "}
            <em>
          ...
          <li className={style.listItemConferenze}>
            <strong>Graglia M.,</strong>
            <strong>Mariotti L., Quercia M.</strong> (2020). &ldquo;Fornire
            supporto ai genitori con figli adolescenti omo/bisessuali:
            l&rsquo;esperienza dell&rsquo;associazione &ldquo;GECO ODV&rdquo; di
            Torino<em>. Rivista Minori e Giustizia, </em>3, pp<em>. </em>
            166-175.
          </li>
          <li className={style.listItemConferenze}>
            <strong>Graglia M.</strong> (2020). Testo dell&rsquo;audizione in
        ...
        <ul className={style.listConferenze}>
          <li className={style.listItemConferenze}>
            <strong>Graglia M.</strong> (2019), Richiedenti asilo LGBTI+.{" "}
            <em>
        ...
        <ul className={style.listConferenze}>
          <li className={style.listItemConferenze}>
            <strong>Graglia M., Nadalin D. (a cura)</strong>&nbsp;(2016),&nbsp;
            <em>Le disforie di genere</em>, Rivista di sessuologia, 40 (2)
          </li>
          <li className={style.listItemConferenze}>
            <strong>Graglia M.</strong> (2016). Sesso, genere e orientamento
            sessuale: dalla confusione alla complessit&agrave;. Graglia M.,
            Nadalin D. (a cura) (2016). La disforia di genere,{" "}
            <em>Rivista di Sessuologia, </em>vol.40, n.2, pp.9-22
          </li>
          <li className={style.listItemConferenze}>
            <strong>Graglia M.</strong>&nbsp;(2016),&nbsp;
            <em>
        ...
        <ul className={style.listConferenze}>
          <li className={style.listItemConferenze}>
            <strong>Graglia M., Quaglia V.</strong>&nbsp;(2014),&nbsp;
            <em>
        ...
        <ul className={style.listConferenze}>
          ...
          <li className={style.listItemConferenze}>
            <strong>Graglia M. (a cura)</strong>&nbsp;(2013),&nbsp;
        ...
        <ul className={style.listConferenze}>
          ...
          <li className={style.listItemConferenze}>
            <strong>Rigliano P., Graglia M. (a cura)</strong>&nbsp;(2012),&nbsp;
        ...
        <ul className={style.listConferenze}>
          ...
          <li className={style.listItemConferenze}>
            <strong>Rigliano P., Graglia M.</strong>&nbsp;(2006),&nbsp;
